...
/**
 * PaymentDetailPermission — 403 permission-denied state for the payment
 * detail page. Backend 403 is authoritative; never auto-retried.
 */
export const PaymentDetailPermission: FC = () => {
  return (
    <div
    ...
    >
      ...
      <p className="mt-2 max-w-md text-body text-neutral-500">
        Your account does not have access to this payment record. Ask a clinic
