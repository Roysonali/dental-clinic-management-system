/**
 * Receipt formatting helpers (Sprint 14A.5).
 *
 * Single source of truth for receipt currency/date display. Amounts use the
...
/** Format a receipt monetary value in the Billing presentation currency. */
...
export function formatReceiptDateTime(datetimeStr: string | null | undefined): string {
