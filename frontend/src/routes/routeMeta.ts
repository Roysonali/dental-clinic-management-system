...
const ROUTE_META: Record<string, RouteMeta> = {
  ...
  [ROUTES.BILLING]: { title: 'Billing Dashboard', subtitle: 'Clinic financial overview' },
  [ROUTES.BILLING_INVOICES]: { title: 'Invoices' },
  [ROUTES.BILLING_PAYMENTS]: { title: 'Payments' },
  [ROUTES.BILLING_CREDIT_NOTES]: { title: 'Credit Notes' },
  [ROUTES.BILLING_RECEIPTS]: { title: 'Receipts' },
  [ROUTES.BILLING_REFUNDS]: { title: 'Refunds' },
